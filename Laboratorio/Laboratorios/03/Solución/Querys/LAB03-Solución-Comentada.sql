...
CONSTRAINT Horario_Valido check(Horario_Disponible = 'MAT0' OR Horario_Disponible = 'MAT1' OR Horario_Disponible = 'MAT2' OR 
								...
								--Se puede utilizar una expresión regular para poder usar N cantidad de validaciones
								--constraint uc_horario check(horario like 'MAT[0-9]')
...
constraint cf_almacen_localidad  En el nombre logico se colocan las 2 tablas que se van a relacionar.

Los nombres SIEMPRE deben de ser 'unique', sino con autoincrementables se repetirán nombres n veces.

No se puede mandar valor especifico a columna tipo 'identity'
...
uc
La u es de User, osea "Restricciones de usuario"
Con esto se logra identificar que creó el usuario y que cosas son propias de la base de datos.
*/
